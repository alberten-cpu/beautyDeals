...
@section('content')
    ...
    <div class="content-header">
        ...
        <x-admin.ui.card-form title="Deal Details" form-route="deals.update" form-id="edit_deal" enctype form-route-id="{{ $product->id }}">
            <x-slot name="input">
                <div class="mb-3">
                ...
                <div>
                    @foreach($product->productImages as $productImages)
                        <img src="{{ asset('Product/'.$product->id.'/'.$productImages?->imagePath) }}" alt="" style="width:150px">
                    @endforeach
                </div>
